import { Typography, Box, FormControl, FormHelperText, TextField, TextareaAutosize, Stack, Select, MenuItem, Button } from '@mui/material';
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        ...
        onSubmit={handleSubmit(onFinishHandler)}>
          ...
          <FormControl>
            ...
            <TextareaAutosize minRows={5} required placeholder="Write description" color="info" 
            style={{width: '100%', background: 'transparent', fontSize: '16px', borderColor: 'rgba(0,0,0,0.23)', borderRadius: 6,
            padding: 10, color: '#919191'}}  {...register('description', {required: true})}/>
          </FormControl>
          ...
          <FormControl>
            <FormHelperText sx={{fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d'}}>Enter property location</FormHelperText>
          ...
          <Stack direction="column" gap={1} justifyContent="center" mb={2}>
            ...
            <Typography color="#808191" fontSize={14} sx={{wordBreak: 'break-all'}}>
                {propertyImage?.name}
              </Typography>
